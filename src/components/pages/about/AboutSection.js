...
const AboutSection = () => {
  ...
  return (
    ...
    <div className='grid-px-5 drop-shadow-2xl'>
        ...
        <div className='m-5 md:mx-20 grid grid-cols-4'>
            <div className='col-span-2'>
                ...
                <p className='indent-8 leading-relaxed text-left text-sm tracking-normal md:text-lg md:px-5'>
                    Located at Amorsolo Street, which runs parallel to Ayala Avenue. AONE goes above and beyond the essentials to cater to the distinctive way of life led by each individual resident. A luxurious lobby, office floors, podium and parking, residential floors, and an extravagant amenity deck with a view of Makati and Manila Bay in 360 degrees. This customization requires careful planning in addition to creative thinking. However, it is no longer necessary to imagine one's perfect apartment in a premier city because one's home has already been delivered.
                </p>
            </div>
