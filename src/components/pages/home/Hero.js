  ...
  return (
    <div className='w-full relative pt-5 md:pt-0' id='home'>
        ...
        <div className='absolute flex flex-col justify-evenly h-full ml-5 md:ml-10 p-5'>
            ...
            <img src={logo} alt='LOGO' className='mt-0 h-16 w-1/2 md:h-40 md:w-11/12'/>
            <Link to='/About'><button className='text-xxs mt-0 md:text-xl tracking-wide text-white font-black bg-yellow uppercase w-1/2 md:w-2/4 py-1 md:py-3 md:px-5 hover:opacity-75'>
              Learn More
            </button></Link>
        </div>
